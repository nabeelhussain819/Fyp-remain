...
const OwnDepartment = () => {
  ...
  //   const res = await fetch("http://localhost:5000/get-depart", {
  //     method: "POST",
  ...
  const getData = async () => {
    ...
    response.map((data) =>
      localStorage.getItem("id") == data._id ? setDepart([data]) : null
    );
  };
  useEffect(() => {
    getData();
                          ...
                          <div id="itinerary" className="page-scroll">
                            <div className="single-content-item padding-top-40px padding-bottom-40px">
                              ...
                              <div
                                ...
                                id="accordionExample"
                              >
                                {/* {Object.entries(index.teacherId)
                                  .slice(0, 4)
                                  .map(([i, index]) => {
                                    return (
                                      <div className="card">
                              ...
                              <div className="sidebar-widget-item">
                                <div className="qty-box mb-2 d-flex align-items-center justify-content-between">
                                  <label className="font-size-16">
                                    Total Programs
                                    <span>
                                      Available Programs in {index.name}
                                    </span>
                                  </label>
                                ...
                                <div className="qty-box mb-2 d-flex align-items-center justify-content-between">
                                  <label className="font-size-16">
                                    Total Sessions
                                    <span>
                                      Available Sessions in {index.name}
                                    </span>
                                  </label>
                                  <div className="qtyBtn d-flex align-items-center">
                                    <input
                                ...
                                <div className="qty-box mb-2 d-flex align-items-center justify-content-between">
                                  <label className="font-size-16">
                                    Total Teachers{" "}
                                    <span>
                                      Available Teachers in {index.name}
                                    </span>
                                  </label>
                                  <div className="qtyBtn d-flex align-items-center">
                                    <input
