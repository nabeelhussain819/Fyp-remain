...
import Commend from "../Index/Commend";
import DepartmentReview from "../../../Components/ReviewBox/DepartmentReview";
...
const Department = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      response.map((data) => {
        return data._id == params.id ? setDept([data]) : null;
      });
    };
    getData();
  }, []);
              ...
              <div className="col-lg-12">
                <div className="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                  <div className="section-heading text-left">
                    <h2 className="sec__">Department Details</h2>
                    {dept.map((data) => {
                      return (
                    ...
                    <>
                      <div className="sidebar-widget single-content-widget">
                        <div className="sidebar-widget-item">
                          <div className="sidebar-book--wrap mb-3">
                            <h3>
                              {data.name} <Commend />
                            </h3>
