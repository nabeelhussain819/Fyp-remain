...
export default function DepartmentReview({ data }) {
  const [comment, setComment] = useState("");
  const [value, setValue] = useState("");
  const [studentId, setUserId] = useState(localStorage.getItem("id"));
  const [departmentId, setCourseId] = useState([data._id]);
  console.log(value);
  const CommentC = async (e) => {
    e.preventDefault();
    const res = await fetch("http://localhost:5000/department-comment", {
      method: "POST",
          ...
          <div class="comment">
            ...
            <div class="comment-body">
              ...
              <p class="comment-content">
                Lorem ipsum dolor sit amet, dolores mandamus moderatius ea ius,
                sed civibus vivendum imperdiet ei, amet tritani sea id. Ut veri
                diceret fierent mei, qui facilisi suavitate euripidis
              </p>
            </div>
          </div>
          <div class="comment">
